...
function import_module_code(name, file) {
    ...
    return 'var ' + name + ' = (function() {' + 'var module = {};' + 'var exports = module.exports = {};' + code + '; return module.exports;' + '})();';
}
...
function bundle_node(b, props) {
    ...
    var out = lines.join('\n');
    if (props.compress || (typeof props.compress == 'undefined'))
        out = compress(out);
    return out;
}
